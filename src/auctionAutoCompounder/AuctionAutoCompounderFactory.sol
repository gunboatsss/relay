...
import {AuctionAutoCompounder} from "./AuctionAutoCompounder.sol";
...
/// @title AuctionAutoCompounderFactory
...
contract AuctionAutoCompounderFactory is IAutoCompounderFactory, RelayFactory {
    ...
    function _deployRelayInstance(
        ...
        autoCompounder = address(new AuctionAutoCompounder(voter, _admin, _name, router, defaultOptimizer, address(this)));
    }
